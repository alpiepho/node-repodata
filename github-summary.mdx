...
(Warning: many images) This a summary of all the Github Repos I have added over the years.  Some are forks of other projects with minor changes.  Most are orignal works.
  ...
  **NOTE:** This lists 74 repos total, 6 forked, and 68 my public.
  
  

### 1) AlPiepho<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 18) gc-stats<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 20) go_wasm<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 21) gophercises<span style="color:grey;font-weight:200">[go]</span> 
...
### 22) <span style="color:orange;font-weight:200">[fork]</span> junit-plugin<span style="color:grey;font-weight:200">[java]</span> 
[junit-plugin](https://github.com/alpiepho/junit-plugin/blob/master/README.md)
: Allows JUnit-format test results to be published
- Extended this for a work project

### 23) leadership<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 24) mental-models<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 25) my-blog<span style="color:grey;font-weight:200">[javascript]</span> 
[my-blog](https://github.com/alpiepho/my-blog/blob/master/README.md)
: My first blog based on a React/Gatsby starter project.

### 26) my-blog2<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 27) my-gatsby-project<span style="color:grey;font-weight:200">[css]</span> 
...
### 28) my-gatsby-project-netlify<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 29) my-pure-css<span style="color:grey;font-weight:200">[html]</span> 
...
### 30) node-overcast-rss<span style="color:grey;font-weight:200">[html]</span> 
...
### 31) node-repodata<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 32) <span style="color:orange;font-weight:200">[fork]</span> pi-gen<span style="color:grey;font-weight:200">[shell]</span> 
...
### 33) project-portfolio<span style="color:grey;font-weight:200">[html]</span> 
...
### 34) project-portfolio-html<span style="color:grey;font-weight:200">[html]</span> 
[project-portfolio-html](https://github.com/alpiepho/project-portfolio-html/blob/master/README.md)
: Original html version

### 35) project-portfolio0<span style="color:grey;font-weight:200">[html]</span> 
[project-portfolio0](https://github.com/alpiepho/project-portfolio0)
: Original portfolio written in HTML, Javascript and CSS

### 36) project-portfolio1<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 37) project-portfolio2<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 38) project-portfolio3<span style="color:grey;font-weight:200">[javascript]</span> 
[project-portfolio3](https://github.com/alpiepho/project-portfolio3/blob/master/README.md)
: Portfolio ported to Jekyll

### 39) pup-learning<span style="color:grey;font-weight:200">[html]</span> 
...
### 40) pup-learning-aws<span style="color:grey;font-weight:200">[html]</span> 
...
### 41) pup-lynda<span style="color:grey;font-weight:200">[html]</span> 
...
### 42) pup-parse-bsb<span style="color:grey;font-weight:200">[javascript]</span> 
[pup-parse-bsb](https://github.com/alpiepho/pup-parse-bsb/blob/master/README.md)
: Parse baseball scores using puppeteer

### 43) pup-rally<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 50) <span style="color:orange;font-weight:200">[fork]</span> renderjson
[renderjson](https://github.com/alpiepho/renderjson/blob/master/README.md)
: Render JSON into collapsible HTML

### 51) rpi_parking_sensor<span style="color:grey;font-weight:200">[python]</span> 
...
### 52) rpn-calc-chrome-extension<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 53) rpn-calc-vscode-extension<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 54) rpn-hex-calculator-mobile<span style="color:grey;font-weight:200">[c#]</span> 
...
### 55) simple-score-vb-error<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 56) simple-score-vb-serve<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 57) simple-score-volleyball-pwa<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 61) site-evaluation-larimer-county-workforce-development
...
### 67) site-evaluation-triplecrown
[site-evaluation-triplecrown](https://github.com/alpiepho/site-evaluation-triplecrown/blob/master/README.md)
: Complimentary site evaluation.

### 68) state-web-development-2018-2019-withD3-pwa<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 69) state-web-development-2018-2019-withD3-static<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 70) terms-pwa-starter<span style="color:grey;font-weight:200">[javascript]</span> 
...
### 72) <span style="color:orange;font-weight:200">[fork]</span> vscode<span style="color:grey;font-weight:200">[typescript]</span> 
...
### 73) <span style="color:orange;font-weight:200">[fork]</span> vscode-diff
