...
function finishSpecialReadme(header, jsonData) {
  ...
  jsonData.forEach((element, index) => {
    ...
    switch(element.language) {
      case "C":
        fileData += "![##545454](https://placehold.it/15/545454/000000?text=+) Javascript<br>" + "\n"
        break;
      case "C++":
        fileData += "![##F34B7C](https://placehold.it/15/f34b7/000000?text=+) Javascript<br>" + "\n"
        break;
      case "C#":
        fileData += "![##178600](https://placehold.it/15/178600/000000?text=+) Javascript<br>" + "\n"
        break;
      case "CSS":
        fileData += "![##58407E](https://placehold.it/15/58407e/000000?text=+) Javascript<br>" + "\n"
        break;
      case "Go":
        fileData += "![##00ADD8](https://placehold.it/15/00add8/000000?text=+) Javascript<br>" + "\n"
        break;
      case "HTML":
        fileData += "![##E34C27](https://placehold.it/15/e34c27/000000?text=+) Javascript<br>" + "\n"
        break;
      case "Java":
        fileData += "![##B07218](https://placehold.it/15/b07218/000000?text=+) Javascript<br>" + "\n"
        break;
      case "JavaScript":
        fileData += "![#F1E05A](https://placehold.it/15/f1e05a/000000?text=+) Javascript<br>" + "\n"
        break;
      case "PHP":
        fileData += "![##4F5D94](https://placehold.it/15/4f5d94/000000?text=+) Javascript<br>" + "\n"
        break;
      case "Python":
        fileData += "![##3571A5](https://placehold.it/15/3571a5/000000?text=+) Javascript<br>" + "\n"
        break;
      case "Shell":
        fileData += "![##89E050](https://placehold.it/15/89e050/000000?text=+) Javascript<br>" + "\n"
        break;
      case "TypeScript":
        fileData += "![##2B7489](https://placehold.it/15/2b7489/000000?text=+) Javascript<br>" + "\n"
        break;
      default:
        fileData += "![#FFFFFF](https://placehold.it/15/ffffff/000000?text=+) unknown language<br>" + "\n"
        break;
    }
    //TODO fix this
